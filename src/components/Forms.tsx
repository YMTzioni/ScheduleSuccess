    ...
    <section className="card">
      ...
      {isMichaelTemplate && startDate && (
        <div className="recommendation-panel recommendation-ok template-michael-panel">
          ...
          <ul>
            <li>תקופת לימודים מינימום שנה מלאה — ימי תרגול חומר יתווספו לפי הצורך</li>
      ...
      <p className="hint">
        {isMichaelTemplate
          ? 'תבנית מיכאל: תקופת לימודים של שנה לפחות. אם חסרים שיעורים — יתווספו ימי תרגול חומר. מסלולים לפי סדר, 2 ימים בשבוע, 8 שעות ביום.'
          : endDateMode === 'auto'
