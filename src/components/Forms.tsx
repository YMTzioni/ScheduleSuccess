    ...
    <section className="card">
      ...
      {isMichaelTemplate && startDate && (
        <div className="recommendation-panel recommendation-ok template-michael-panel">
          ...
          <ul>
            <li>תקופת לימודים מינימום שנה מלאה — תרגול חומר פעמיים בחודש (אקראי)</li>
      ...
      <p className="hint">
        {isMichaelTemplate
          ? 'תבנית מיכאל: תקופת לימודים של שנה לפחות, תרגול חומר פעמיים בחודש (באופן אקראי). מסלולים לפי סדר, 2 ימים בשבוע, 8 שעות ביום.'
          : endDateMode === 'auto'
